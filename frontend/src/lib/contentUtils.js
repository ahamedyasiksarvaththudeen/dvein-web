// ─── Default CMS Content ─────────────────────────────────────────────────────
// Kept in a separate module so ContentContext.jsx (which only exports React
// components) can import it without breaking Vite's Fast Refresh (UI-27).
// Add images[] and videos[] to careerHub.successStory so the CMS can manage them.
...
export const defaultContent = {
  ...
  careerHub: {
    ...
    successStory: {
      ...
      // ← CMS-managed media (empty arrays = fall back to bundled assets in CareerHub.jsx)
      images: [],
      videos: [],
    },
    dna: {
